...
const navMenu = document.querySelector(".mainMenu-mobile");
const hamMobile = document.querySelector(".hamburger-m");
const hidden2 = document.getElementById("hidden");
// const hidden = document.querySelectorAll(".hidden");

hamburger.addEventListener("click", () => {
   hamburger.classList.toggle("active");
   navMenu.classList.toggle("active");
   hidden2.classList.toggle("active");
